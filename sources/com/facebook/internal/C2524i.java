...
public class C2524i {
    ...
    /* renamed from: a */
    private static final HashSet<String> f7910a = m9611a();

    /* renamed from: a */
    private static HashSet<String> m9611a() {
    ...
    /* renamed from: a */
    public static boolean m9612a(Context context, String str) {
        ...
        try {
            ...
            for (Signature byteArray : packageInfo.signatures) {
                if (!f7910a.contains(C2479ad.m9432a(byteArray.toByteArray()))) {
                    return false;
                }
            }
            return true;
