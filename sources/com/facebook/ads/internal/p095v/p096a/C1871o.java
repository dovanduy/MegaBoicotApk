...
/* renamed from: com.facebook.ads.internal.v.a.o */
public class C1871o {
    /* renamed from: a */
    private static String m7853a(byte[] bArr, String str) {
    ...
    /* renamed from: a */
    public static void m7854a(HttpsURLConnection httpsURLConnection, Set<String> set, Set<String> set2) {
        if (VERSION.SDK_INT != 15 || !"4.0.3".equals(VERSION.RELEASE)) {
            try {
                ...
                while (i < length) {
                    ...
                    String a = m7853a(x509Certificate.getEncoded(), "SHA-1");
                    if (set == null || !set.contains(a)) {
                        String a2 = m7853a(x509Certificate.getPublicKey().getEncoded(), "SHA-1");
