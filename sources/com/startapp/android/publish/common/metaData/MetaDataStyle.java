...
public class MetaDataStyle implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!C5307i.m22682b(this.name, metaDataStyle.name) || !C5307i.m22682b(this.itemGradientTop, metaDataStyle.itemGradientTop) || !C5307i.m22682b(this.itemGradientBottom, metaDataStyle.itemGradientBottom) || !C5307i.m22682b(this.itemTitleTextSize, metaDataStyle.itemTitleTextSize) || !C5307i.m22682b(this.itemTitleTextColor, metaDataStyle.itemTitleTextColor) || !C5307i.m22682b(this.itemTitleTextDecoration, metaDataStyle.itemTitleTextDecoration) || !C5307i.m22682b(this.itemDescriptionTextSize, metaDataStyle.itemDescriptionTextSize) || !C5307i.m22682b(this.itemDescriptionTextColor, metaDataStyle.itemDescriptionTextColor) || !C5307i.m22682b(this.itemDescriptionTextDecoration, metaDataStyle.itemDescriptionTextDecoration)) {
            z = false;
        }
        return z;
    }
    ...
    public int hashCode() {
        return C5307i.m22652a(this.name, this.itemGradientTop, this.itemGradientBottom, this.itemTitleTextSize, this.itemTitleTextColor, this.itemTitleTextDecoration, this.itemDescriptionTextSize, this.itemDescriptionTextColor, this.itemDescriptionTextDecoration);
    }
}
