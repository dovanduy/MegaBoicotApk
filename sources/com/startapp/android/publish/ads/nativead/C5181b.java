...
public class C5181b extends C5395h {
    private static final long serialVersionUID = 1;
    private NativeAdPreferences config;

    public C5181b(Context context, NativeAdPreferences nativeAdPreferences) {
    ...
    public void loadAds(AdPreferences adPreferences, AdEventListener adEventListener) {
        C5180a aVar = new C5180a(this.context, this, adPreferences, adEventListener, this.config);
        aVar.mo19820c();
    }
}
