...
public class C5207i {
    /* renamed from: a */
    public static View m22289a(Context context, SplashConfig splashConfig) {
        switch (splashConfig.getTheme()) {
            case DEEP_BLUE:
                return m22295g(context, splashConfig);
            case SKY:
                return m22294f(context, splashConfig);
            case ASHEN_SKY:
                return m22293e(context, splashConfig);
            case BLAZE:
                return m22292d(context, splashConfig);
            case GLOOMY:
                return m22291c(context, splashConfig);
            case OCEAN:
                return m22290b(context, splashConfig);
            default:
                return null;
        }
    }
    ...
    /* renamed from: b */
    private static View m22290b(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
    ...
    /* renamed from: c */
    private static View m22291c(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
        h.setBackgroundColor(Color.rgb(47, 53, 63));
        ((TextView) h.findViewById(100)).setTextColor(Color.rgb(51, 181, 229));
        ((TextView) h.findViewById(105)).setTextColor(Color.rgb(122, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, 139));
        return h;
    }

    /* renamed from: d */
    private static View m22292d(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
    ...
    /* renamed from: e */
    private static View m22293e(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
    ...
    /* renamed from: f */
    private static View m22294f(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
        int i = context.getResources().getDisplayMetrics().widthPixels;
    ...
    /* renamed from: g */
    private static View m22295g(Context context, SplashConfig splashConfig) {
        View h = m22296h(context, splashConfig);
    ...
    /* renamed from: h */
    private static View m22296h(Context context, SplashConfig splashConfig) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        Point point = new Point(C5306h.m22641a(context2, (int) C1245d.f3968jk), C5306h.m22641a(context2, 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i4 = C5306h.m22641a(context2, 5);
            i3 = C5306h.m22641a(context2, 8);
            i2 = C5306h.m22641a(context2, 75);
            i = C5306h.m22641a(context2, (int) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        } else {
            i4 = C5306h.m22641a(context2, 5);
            i3 = C5306h.m22641a(context2, 8);
            i2 = C5306h.m22641a(context2, 40);
            i = C5306h.m22641a(context2, 100);
        }
        ...
        try {
            ...
            C5378f.m23016a(context2, C5376d.EXCEPTION, "TemplatesLayout.getBaseTemplate - webview failed", e.getMessage(), "");
        }
