...
public class C5422a {
    ...
    /* renamed from: a */
    private final Rect f17321a = new Rect();

    /* renamed from: a */
    public boolean mo19974a(View view, int i) {
        boolean z = false;
        if (view == null || !view.hasWindowFocus() || !view.isShown() || m23134a(view) || view.getRootView() == null || view.getRootView().getParent() == null || !view.getGlobalVisibleRect(this.f17321a)) {
            return false;
        }
        if (view.getParent() instanceof ViewGroup) {
            ...
            for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
                ...
                if (childAt.getVisibility() == 0 && m23135a(view, childAt, 0)) {
                    return false;
                }
            }
        }
        long height = ((long) this.f17321a.height()) * ((long) this.f17321a.width());
    ...
    /* renamed from: a */
    private boolean m23134a(View view) {
        return VERSION.SDK_INT >= 11 && view.getAlpha() == 0.0f;
    }

    /* renamed from: a */
    private static boolean m23135a(View view, View view2, int i) {
        int[] iArr = new int[2];
        int[] iArr2 = new int[2];
        ...
        if (max <= 0 || 100 * max <= ((long) i) * height) {
            return false;
        }
        return true;
    }
