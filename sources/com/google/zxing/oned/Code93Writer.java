...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        sb2.append(str);
        sb2.append("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(computeChecksumIndex));
        toIntArray(Code93Reader.CHARACTER_ENCODINGS[computeChecksumIndex(sb2.toString(), 15)], iArr);
