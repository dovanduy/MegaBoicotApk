...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", C1746e.f5472a, C1248f.TAG, "g", "h", "i", "j", "k", "l", "m", "n", "o", TtmlNode.TAG_P, "q", "r", "s", C1237d.COLUMN_TYPE, "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
        ...
        while (i8 < nbLayers) {
            ...
            while (i13 < i10) {
                ...
                while (i15 < i2) {
                    ...
                    int i18 = i12 - i15;
                    boolean z = isCompact;
                    zArr[(2 * i10) + i9 + i14 + i15] = bitMatrix2.get(iArr[i17], iArr[i18]);
                    int i19 = i12 - i13;
                    int i20 = nbLayers;
                    zArr[(4 * i10) + i9 + i14 + i15] = bitMatrix2.get(iArr[i18], iArr[i19]);
