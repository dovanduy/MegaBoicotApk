...
final class PlaybackInfo {
    ...
    public PlaybackInfo(Timeline timeline2, long j, TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult2) {
        this(timeline2, null, new MediaPeriodId(0), j, C2793C.TIME_UNSET, 1, false, trackGroupArray, trackSelectorResult2);
    }

    public PlaybackInfo(Timeline timeline2, Object obj, MediaPeriodId mediaPeriodId, long j, long j2, int i, boolean z, TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult2) {
    ...
    public PlaybackInfo fromNewPosition(MediaPeriodId mediaPeriodId, long j, long j2) {
        PlaybackInfo playbackInfo = new PlaybackInfo(this.timeline, this.manifest, mediaPeriodId, j, mediaPeriodId.isAd() ? j2 : -9223372036854775807L, this.playbackState, this.isLoading, this.trackGroups, this.trackSelectorResult);
        return playbackInfo;
    }
