...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, TrackSelection trackSelection2, DataSource dataSource2, TrackEncryptionBox[] trackEncryptionBoxArr) {
        ...
        while (i3 < this.extractorWrappers.length) {
            ...
            int i4 = i3;
            Track track = r7;
            Track track2 = new Track(indexInTrackGroup, streamElement.type, streamElement.timescale, C2793C.TIME_UNSET, ssManifest2.durationUs, format, 0, trackEncryptionBoxArr, streamElement.type == 2 ? 4 : 0, null, null);
    ...
    public final void getNextChunk(MediaChunk mediaChunk, long j, long j2, ChunkHolder chunkHolder) {
        ...
        if (this.fatalError == null) {
            ...
            if (mediaChunk == null) {
                ...
                nextChunkIndex = (int) (mediaChunk.getNextChunkIndex() - ((long) this.currentManifestChunkOffset));
                if (nextChunkIndex < 0) {
            ...
            this.trackSelection.updateSelectedTrack(j3, j4 - j3, resolveTimeToLiveEdgeUs(j3));
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource2, Uri uri, String str, int i, long j, long j2, long j3, int i2, Object obj, ChunkExtractorWrapper chunkExtractorWrapper) {
        DataSpec dataSpec = new DataSpec(uri, 0, -1, str);
        ContainerMediaChunk containerMediaChunk = new ContainerMediaChunk(dataSource2, dataSpec, format, i2, obj, j, j2, j3, (long) i, 1, j, chunkExtractorWrapper);
