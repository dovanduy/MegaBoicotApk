...
public final class DefaultContentMetadata implements ContentMetadata {
    ...
    public final String get(String str, String str2) {
        return this.metadata.containsKey(str) ? new String((byte[]) this.metadata.get(str), Charset.forName(C2793C.UTF8_NAME)) : str2;
    }
    ...
    private static void addValues(HashMap<String, byte[]> hashMap, Map<String, Object> map) {
        for (String str : map.keySet()) {
            ...
            if (bytes.length > MAX_VALUE_LENGTH) {
                throw new IllegalArgumentException(String.format("The size of %s (%d) is greater than maximum allowed: %d", new Object[]{str, Integer.valueOf(bytes.length), Integer.valueOf(MAX_VALUE_LENGTH)}));
            }
    ...
    private static byte[] getBytes(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(Charset.forName(C2793C.UTF8_NAME));
        }
