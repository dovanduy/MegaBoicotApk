    ...
    public synchronized void release(Allocation[] allocationArr) {
        ...
        while (i < length) {
            ...
            if (allocation.data == this.initialAllocationBlock || allocation.data.length == this.individualAllocationSize) {
                ...
                sb.append(System.identityHashCode(allocation.data));
                sb.append(", ");
                sb.append(System.identityHashCode(this.initialAllocationBlock));
                sb.append(", ");
                sb.append(allocation.data.length);
                sb.append(", ");
                sb.append(this.individualAllocationSize);
