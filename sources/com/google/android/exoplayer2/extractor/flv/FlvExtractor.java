...
public final class FlvExtractor implements Extractor {
    ...
    private long mediaTagTimestampOffsetUs = C2793C.TIME_UNSET;
    ...
    public void seek(long j, long j2) {
        this.state = 1;
        this.mediaTagTimestampOffsetUs = C2793C.TIME_UNSET;
    ...
    private boolean readTagData(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.tagType == 8 && this.audioReader != null) {
            ...
            if (durationUs != C2793C.TIME_UNSET) {
    ...
    private void ensureReadyForMediaOutput() {
        if (!this.outputSeekMap) {
            this.extractorOutput.seekMap(new Unseekable(C2793C.TIME_UNSET));
            this.outputSeekMap = true;
        }
        if (this.mediaTagTimestampOffsetUs == C2793C.TIME_UNSET) {
            this.mediaTagTimestampOffsetUs = this.metadataReader.getDurationUs() == C2793C.TIME_UNSET ? -this.tagTimestampUs : 0;
        }
    }
}
