...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        TtmlNode ttmlNode = new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C2793C.TIME_UNSET, C2793C.TIME_UNSET, null, null, "");
        return ttmlNode;
    }
    ...
    public boolean isActive(long j) {
        return (this.startTimeUs == C2793C.TIME_UNSET && this.endTimeUs == C2793C.TIME_UNSET) || (this.startTimeUs <= j && this.endTimeUs == C2793C.TIME_UNSET) || ((this.startTimeUs == C2793C.TIME_UNSET && j < this.endTimeUs) || (this.startTimeUs <= j && j < this.endTimeUs));
    }
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z) {
        ...
        if (z || equals) {
            if (this.startTimeUs != C2793C.TIME_UNSET) {
                treeSet.add(Long.valueOf(this.startTimeUs));
            }
            if (this.endTimeUs != C2793C.TIME_UNSET) {
    ...
    public List<Cue> getCues(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2) {
        ...
        for (Entry entry : treeMap.entrySet()) {
            ...
            Cue cue = new Cue((CharSequence) cleanUpText((SpannableStringBuilder) entry.getValue()), (Alignment) null, ttmlRegion.line, ttmlRegion.lineType, ttmlRegion.lineAnchor, ttmlRegion.position, Integer.MIN_VALUE, ttmlRegion.width, ttmlRegion.textSizeType, ttmlRegion.textSize);
            arrayList.add(cue);
        }
        return arrayList;
    }
