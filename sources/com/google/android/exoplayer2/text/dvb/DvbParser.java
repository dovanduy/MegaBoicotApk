...
final class DvbParser {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService2.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0) {
                        parseRegionComposition.mergeFrom((RegionComposition) subtitleService2.regions.get(parseRegionComposition.f8653id));
                    }
                    subtitleService2.regions.put(parseRegionComposition.f8653id, parseRegionComposition);
                    break;
                }
            case 18:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryCluts.put(parseClutDefinition.f8651id, parseClutDefinition);
                        break;
                    }
                } else {
                    ClutDefinition parseClutDefinition2 = parseClutDefinition(parsableBitArray, readBits3);
                    subtitleService2.cluts.put(parseClutDefinition2.f8651id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryObjects.put(parseObjectData.f8652id, parseObjectData);
                        break;
                    }
                } else {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService2.objects.put(parseObjectData2.f8652id, parseObjectData2);
                    break;
                }
                break;
            case 20:
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r3v9
      assigns: []
      uses: []
      mth insns count: 62
