...
public final class TimestampAdjuster {
    ...
    private volatile long lastSampleTimestampUs = C2793C.TIME_UNSET;
    ...
    public synchronized void setFirstSampleTimestampUs(long j) {
        Assertions.checkState(this.lastSampleTimestampUs == C2793C.TIME_UNSET);
    ...
    public long getLastAdjustedTimestampUs() {
        if (this.lastSampleTimestampUs != C2793C.TIME_UNSET) {
            return this.lastSampleTimestampUs + this.timestampOffsetUs;
        }
        return this.firstSampleTimestampUs != Long.MAX_VALUE ? this.firstSampleTimestampUs : C2793C.TIME_UNSET;
    }
    ...
    public long getTimestampOffsetUs() {
        ...
        return this.lastSampleTimestampUs == C2793C.TIME_UNSET ? C2793C.TIME_UNSET : this.timestampOffsetUs;
    }

    public void reset() {
        this.lastSampleTimestampUs = C2793C.TIME_UNSET;
    }
    ...
    public synchronized void waitUntilInitialized() throws InterruptedException {
        while (this.lastSampleTimestampUs == C2793C.TIME_UNSET) {
            wait();
        }
    }
