...
public final class Util {
    ...
    public static String fromUtf8Bytes(byte[] bArr) {
        return new String(bArr, Charset.forName(C2793C.UTF8_NAME));
    }

    public static String fromUtf8Bytes(byte[] bArr, int i, int i2) {
        return new String(bArr, i, i2, Charset.forName(C2793C.UTF8_NAME));
    }

    public static byte[] getUtf8Bytes(String str) {
        return str.getBytes(Charset.forName(C2793C.UTF8_NAME));
    }
    ...
    public static java.util.UUID getDrmUuid(java.lang.String r3) {
        ...
        L_0x003a:
            java.util.UUID r3 = java.util.UUID.fromString(r3)     // Catch:{ RuntimeException -> 0x0049 }
            goto L_0x0048
        L_0x003f:
            java.util.UUID r3 = com.google.android.exoplayer2.C2793C.CLEARKEY_UUID
            return r3
        L_0x0042:
            java.util.UUID r3 = com.google.android.exoplayer2.C2793C.PLAYREADY_UUID
            return r3
        L_0x0045:
            java.util.UUID r3 = com.google.android.exoplayer2.C2793C.WIDEVINE_UUID
            return r3
        L_0x0048:
            return r3
        L_0x0049:
    ...
    public static int getDefaultBufferSize(int i) {
        switch (i) {
            case 0:
                return C2793C.DEFAULT_MUXED_BUFFER_SIZE;
            case 1:
                return C2793C.DEFAULT_AUDIO_BUFFER_SIZE;
            case 2:
                return C2793C.DEFAULT_VIDEO_BUFFER_SIZE;
            case 3:
                return 131072;
            case 4:
                return 131072;
