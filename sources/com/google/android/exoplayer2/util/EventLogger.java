...
public class EventLogger implements AnalyticsListener {
    ...
    public void onViewportSizeChange(EventTime eventTime, int i, int i2) {
        ...
        sb.append(", ");
        sb.append(i2);
        logd(eventTime, "viewportSizeChanged", sb.toString());
    }
    ...
    private String getEventTimeString(EventTime eventTime) {
        ...
        if (eventTime.mediaPeriodId != null) {
            ...
            sb3.append(sb2);
            sb3.append(", period=");
            sb3.append(eventTime.mediaPeriodId.periodIndex);
            sb2 = sb3.toString();
    ...
    private static String getTimeString(long j) {
        return j == C2793C.TIME_UNSET ? "?" : TIME_FORMAT.format((double) (((float) j) / 1000.0f));
    }
