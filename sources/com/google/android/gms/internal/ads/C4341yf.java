...
public final class C4341yf {
    /* renamed from: a */
    public static int m18668a(EllipticCurve ellipticCurve) throws GeneralSecurityException {
        return (m18675b(ellipticCurve).subtract(BigInteger.ONE).bitLength() + 7) / 8;
    }

    /* renamed from: a */
    public static KeyPair m18669a(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) C4346yk.f14253d.mo16218a("EC");
        keyPairGenerator.initialize(eCParameterSpec);
        return keyPairGenerator.generateKeyPair();
    }

    /* renamed from: a */
    public static ECPublicKey m18670a(C4343yh yhVar, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec a = m18671a(yhVar);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        m18673a(eCPoint, a.getCurve());
        return (ECPublicKey) ((KeyFactory) C4346yk.f14254e.mo16218a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, a));
    }

    /* renamed from: a */
    public static ECParameterSpec m18671a(C4343yh yhVar) throws NoSuchAlgorithmException {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        switch (C4342yg.f14239b[yhVar.ordinal()]) {
            case 1:
        ...
        return m18672a(str, str2, str3, str4, str5);
    }

    /* renamed from: a */
    private static ECParameterSpec m18672a(String str, String str2, String str3, String str4, String str5) {
        BigInteger bigInteger = new BigInteger(str);
        return new ECParameterSpec(new EllipticCurve(new ECFieldFp(bigInteger), bigInteger.subtract(new BigInteger("3")), new BigInteger(str3, 16)), new ECPoint(new BigInteger(str4, 16), new BigInteger(str5, 16)), new BigInteger(str2), 1);
    }

    /* renamed from: a */
    static void m18673a(ECPoint eCPoint, EllipticCurve ellipticCurve) throws GeneralSecurityException {
        BigInteger b = m18675b(ellipticCurve);
    ...
    /* renamed from: a */
    public static byte[] m18674a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        BigInteger bigInteger;
        m18673a(eCPoint, eCPrivateKey.getParams().getCurve());
        ECParameterSpec params = eCPrivateKey.getParams();
        params.getCurve();
        PublicKey generatePublic = KeyFactory.getInstance("EC").generatePublic(new ECPublicKeySpec(eCPoint, params));
        KeyAgreement keyAgreement = (KeyAgreement) C4346yk.f14252c.mo16218a("ECDH");
        keyAgreement.init(eCPrivateKey);
        keyAgreement.doPhase(generatePublic, true);
        byte[] generateSecret = keyAgreement.generateSecret();
        EllipticCurve curve = eCPrivateKey.getParams().getCurve();
        BigInteger bigInteger2 = new BigInteger(1, generateSecret);
        if (bigInteger2.signum() == -1 || bigInteger2.compareTo(m18675b(curve)) != -1) {
            throw new GeneralSecurityException("shared secret is out of range");
        }
        BigInteger b = m18675b(curve);
    ...
    /* renamed from: b */
    private static BigInteger m18675b(EllipticCurve ellipticCurve) throws GeneralSecurityException {
