...
public final class C4889n extends C4836dn {

    /* renamed from: a */
    private final C4890o f15951a = new C4890o(this, mo17154n(), "google_app_measurement_local.db");

    /* renamed from: b */
    private boolean f15952b;

    C4889n(C4764aw awVar) {
        super(awVar);
    }
    ...
    /* renamed from: x */
    public final void mo17737x() {
        mo17141b();
        mo17144d();
        try {
            int delete = 0 + m21300y().delete("messages", null, null);
            if (delete > 0) {
                mo17158r().mo17759x().mo17764a("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            mo17158r().mo17761y_().mo17764a("Error resetting local analytics data. error", e);
        }
    }
    ...
    private final boolean m21299a(int r20, byte[] r21) {
        /*
            r19 = this;
            r1 = r19
            r19.mo17141b()
            r19.mo17144d()
            boolean r2 = r1.f15952b
            r3 = 0
        ...
        L_0x0026:
            ...
            r7 = 0
            r8 = 1
            android.database.sqlite.SQLiteDatabase r9 = r19.m21300y()     // Catch:{ SQLiteFullException -> 0x012d, SQLiteDatabaseLockedException -> 0x011a, SQLiteException -> 0x00eb, all -> 0x00e4 }
            if (r9 != 0) goto L_0x0045
            r1.f15952b = r8     // Catch:{ SQLiteFullException -> 0x0041, SQLiteDatabaseLockedException -> 0x003e, SQLiteException -> 0x0038 }
        ...
        L_0x0069:
            ...
            com.google.android.gms.measurement.internal.r r15 = r19.mo17158r()     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
            com.google.android.gms.measurement.internal.t r15 = r15.mo17761y_()     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
            java.lang.String r4 = "Data loss, local db full"
            r15.mo17763a(r4)     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
            long r16 = r13 - r10
            r10 = 1
            long r13 = r16 + r10
            ...
            com.google.android.gms.measurement.internal.r r4 = r19.mo17158r()     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
            com.google.android.gms.measurement.internal.t r4 = r4.mo17761y_()     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
            ...
            r8 = r18
            r4.mo17766a(r15, r3, r8, r7)     // Catch:{ SQLiteFullException -> 0x0064, SQLiteDatabaseLockedException -> 0x00cf, SQLiteException -> 0x0061, all -> 0x005d }
        L_0x00b7:
        ...
        L_0x00fb:
            ...
            goto L_0x0154
        L_0x00ff:
            com.google.android.gms.measurement.internal.r r4 = r19.mo17158r()     // Catch:{ all -> 0x00fb }
            com.google.android.gms.measurement.internal.t r4 = r4.mo17761y_()     // Catch:{ all -> 0x00fb }
            java.lang.String r8 = "Error writing entry to local database"
            r4.mo17764a(r8, r3)     // Catch:{ all -> 0x00fb }
            r3 = 1
            r1.f15952b = r3     // Catch:{ all -> 0x00fb }
        ...
        L_0x011c:
            long r3 = (long) r6
            android.os.SystemClock.sleep(r3)     // Catch:{ all -> 0x0151 }
            int r6 = r6 + 20
        ...
        L_0x012d:
            ...
            r9 = r7
        L_0x0131:
            com.google.android.gms.measurement.internal.r r4 = r19.mo17158r()     // Catch:{ all -> 0x0151 }
            com.google.android.gms.measurement.internal.t r4 = r4.mo17761y_()     // Catch:{ all -> 0x0151 }
            java.lang.String r8 = "Error writing entry to local database"
            r4.mo17764a(r8, r3)     // Catch:{ all -> 0x0151 }
            r3 = 1
            r1.f15952b = r3     // Catch:{ all -> 0x0151 }
        ...
        L_0x015e:
            throw r2
        L_0x015f:
            com.google.android.gms.measurement.internal.r r2 = r19.mo17158r()
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4889n.m21299a(int, byte[]):boolean");
    }

    /* renamed from: a */
    public final boolean mo17734a(zzag zzag) {
        Parcel obtain = Parcel.obtain();
        zzag.writeToParcel(obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m21299a(0, marshall);
        }
        mo17158r().mo17754i().mo17763a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: a */
    public final boolean mo17735a(zzfv zzfv) {
        Parcel obtain = Parcel.obtain();
        zzfv.writeToParcel(obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m21299a(1, marshall);
        }
        mo17158r().mo17754i().mo17763a("User property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: a */
    public final boolean mo17736a(zzo zzo) {
        mo17156p();
        byte[] a = C4862el.m20971a((Parcelable) zzo);
        if (a.length <= 131072) {
            return m21299a(2, a);
        }
        mo17158r().mo17754i().mo17763a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:?, code lost:
        mo17158r().mo17761y_().mo17763a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:50:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:62:?, code lost:
        mo17158r().mo17761y_().mo17763a("Failed to load user property from local database");
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable> mo17733a(int r22) {
        /*
            r21 = this;
            r1 = r21
            r21.mo17144d()
        ...
        L_0x000e:
            ...
            r2.<init>()
            android.content.Context r4 = r21.mo17154n()
        ...
        L_0x0028:
            ...
            r8 = 1
            android.database.sqlite.SQLiteDatabase r15 = r21.m21300y()     // Catch:{ SQLiteFullException -> 0x01e8, SQLiteDatabaseLockedException -> 0x01d0, SQLiteException -> 0x01a7, all -> 0x01a1 }
            if (r15 != 0) goto L_0x004b
            r1.f15952b = r8     // Catch:{ SQLiteFullException -> 0x0046, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x003e, all -> 0x0039 }
        ...
        L_0x0048:
            ...
            goto L_0x01ec
        L_0x004b:
            r15.beginTransaction()     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            java.lang.String r10 = "messages"
            r9 = 3
            java.lang.String[] r11 = new java.lang.String[r9]     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            java.lang.String r9 = "rowid"
            r11[r5] = r9     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            java.lang.String r9 = "type"
            r11[r8] = r9     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            java.lang.String r9 = "entry"
            r14 = 2
            r11[r14] = r9     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            r12 = 0
            r13 = 0
            r16 = 0
            r17 = 0
            ...
            r9 = 100
            java.lang.String r19 = java.lang.Integer.toString(r9)     // Catch:{ SQLiteFullException -> 0x019c, SQLiteDatabaseLockedException -> 0x0043, SQLiteException -> 0x0194, all -> 0x0190 }
            r9 = r15
            r4 = r14
            r14 = r16
            r3 = r15
            ...
            r16 = r18
            r17 = r19
            android.database.Cursor r9 = r9.query(r10, r11, r12, r13, r14, r15, r16, r17)     // Catch:{ SQLiteFullException -> 0x018d, SQLiteDatabaseLockedException -> 0x0199, SQLiteException -> 0x018a, all -> 0x0188 }
            r10 = -1
        L_0x007f:
            boolean r12 = r9.moveToNext()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            if (r12 == 0) goto L_0x0145
            long r10 = r9.getLong(r5)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r12 = r9.getInt(r8)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            byte[] r13 = r9.getBlob(r4)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            if (r12 != 0) goto L_0x00c7
            android.os.Parcel r12 = android.os.Parcel.obtain()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r14 = r13.length     // Catch:{ a -> 0x00b2 }
            r12.unmarshall(r13, r5, r14)     // Catch:{ a -> 0x00b2 }
            r12.setDataPosition(r5)     // Catch:{ a -> 0x00b2 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzag> r13 = com.google.android.gms.measurement.internal.zzag.CREATOR     // Catch:{ a -> 0x00b2 }
            java.lang.Object r13 = r13.createFromParcel(r12)     // Catch:{ a -> 0x00b2 }
            com.google.android.gms.measurement.internal.zzag r13 = (com.google.android.gms.measurement.internal.zzag) r13     // Catch:{ a -> 0x00b2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            if (r13 == 0) goto L_0x007f
            r2.add(r13)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            goto L_0x007f
        L_0x00af:
            r0 = move-exception
            r4 = r0
            goto L_0x00c3
        L_0x00b2:
            com.google.android.gms.measurement.internal.r r13 = r21.mo17158r()     // Catch:{ all -> 0x00af }
            com.google.android.gms.measurement.internal.t r13 = r13.mo17761y_()     // Catch:{ all -> 0x00af }
            java.lang.String r14 = "Failed to load event from local database"
            r13.mo17763a(r14)     // Catch:{ all -> 0x00af }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            goto L_0x007f
        L_0x00c3:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            throw r4     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
        L_0x00c7:
            if (r12 != r8) goto L_0x00fe
            android.os.Parcel r12 = android.os.Parcel.obtain()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r14 = r13.length     // Catch:{ a -> 0x00e3 }
            r12.unmarshall(r13, r5, r14)     // Catch:{ a -> 0x00e3 }
            r12.setDataPosition(r5)     // Catch:{ a -> 0x00e3 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzfv> r13 = com.google.android.gms.measurement.internal.zzfv.CREATOR     // Catch:{ a -> 0x00e3 }
            java.lang.Object r13 = r13.createFromParcel(r12)     // Catch:{ a -> 0x00e3 }
            com.google.android.gms.measurement.internal.zzfv r13 = (com.google.android.gms.measurement.internal.zzfv) r13     // Catch:{ a -> 0x00e3 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            goto L_0x00f4
        L_0x00e0:
            r0 = move-exception
            ...
            goto L_0x00fa
        L_0x00e3:
            com.google.android.gms.measurement.internal.r r13 = r21.mo17158r()     // Catch:{ all -> 0x00e0 }
            com.google.android.gms.measurement.internal.t r13 = r13.mo17761y_()     // Catch:{ all -> 0x00e0 }
            java.lang.String r14 = "Failed to load user property from local database"
            r13.mo17763a(r14)     // Catch:{ all -> 0x00e0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            r13 = 0
        L_0x00f4:
            if (r13 == 0) goto L_0x007f
        ...
        L_0x00fe:
            ...
            android.os.Parcel r12 = android.os.Parcel.obtain()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r14 = r13.length     // Catch:{ a -> 0x011a }
            r12.unmarshall(r13, r5, r14)     // Catch:{ a -> 0x011a }
            r12.setDataPosition(r5)     // Catch:{ a -> 0x011a }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzo> r13 = com.google.android.gms.measurement.internal.zzo.CREATOR     // Catch:{ a -> 0x011a }
            java.lang.Object r13 = r13.createFromParcel(r12)     // Catch:{ a -> 0x011a }
            com.google.android.gms.measurement.internal.zzo r13 = (com.google.android.gms.measurement.internal.zzo) r13     // Catch:{ a -> 0x011a }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            goto L_0x012b
        L_0x0117:
            r0 = move-exception
            ...
            goto L_0x0132
        L_0x011a:
            com.google.android.gms.measurement.internal.r r13 = r21.mo17158r()     // Catch:{ all -> 0x0117 }
            com.google.android.gms.measurement.internal.t r13 = r13.mo17761y_()     // Catch:{ all -> 0x0117 }
            java.lang.String r14 = "Failed to load user property from local database"
            r13.mo17763a(r14)     // Catch:{ all -> 0x0117 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            r13 = 0
        L_0x012b:
            if (r13 == 0) goto L_0x007f
        ...
        L_0x0132:
            ...
            throw r4     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
        L_0x0136:
            com.google.android.gms.measurement.internal.r r12 = r21.mo17158r()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            com.google.android.gms.measurement.internal.t r12 = r12.mo17761y_()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            java.lang.String r13 = "Unknown record type in local database"
            r12.mo17763a(r13)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            goto L_0x007f
        L_0x0145:
            java.lang.String r4 = "messages"
            java.lang.String r12 = "rowid <= ?"
            java.lang.String[] r13 = new java.lang.String[r8]     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            java.lang.String r10 = java.lang.Long.toString(r10)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            r13[r5] = r10     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r4 = r3.delete(r4, r12, r13)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            int r10 = r2.size()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            if (r4 >= r10) goto L_0x0168
            com.google.android.gms.measurement.internal.r r4 = r21.mo17158r()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            com.google.android.gms.measurement.internal.t r4 = r4.mo17761y_()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            java.lang.String r10 = "Fewer entries removed from local database than expected"
            r4.mo17763a(r10)     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
        L_0x0168:
            r3.setTransactionSuccessful()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
            r3.endTransaction()     // Catch:{ SQLiteFullException -> 0x0184, SQLiteDatabaseLockedException -> 0x0181, SQLiteException -> 0x017d, all -> 0x0179 }
        ...
        L_0x01ab:
            ...
            boolean r4 = r15.inTransaction()     // Catch:{ all -> 0x020b }
            if (r4 == 0) goto L_0x01b6
            r15.endTransaction()     // Catch:{ all -> 0x020b }
        L_0x01b6:
            com.google.android.gms.measurement.internal.r r4 = r21.mo17158r()     // Catch:{ all -> 0x020b }
            com.google.android.gms.measurement.internal.t r4 = r4.mo17761y_()     // Catch:{ all -> 0x020b }
            java.lang.String r10 = "Error reading entries from local database"
            r4.mo17764a(r10, r3)     // Catch:{ all -> 0x020b }
            r1.f15952b = r8     // Catch:{ all -> 0x020b }
        ...
        L_0x01d2:
            long r8 = (long) r7
            android.os.SystemClock.sleep(r8)     // Catch:{ all -> 0x01e3 }
            int r7 = r7 + 20
        ...
        L_0x0218:
            throw r2
        L_0x0219:
            com.google.android.gms.measurement.internal.r r2 = r21.mo17158r()
            com.google.android.gms.measurement.internal.t r2 = r2.mo17754i()
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4889n.mo17733a(int):java.util.List");
    }

    /* renamed from: y */
    private final SQLiteDatabase m21300y() throws SQLiteException {
        if (this.f15952b) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f15951a.getWritableDatabase();
