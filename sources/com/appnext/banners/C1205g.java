...
public class C1205g extends C1169a {
    ...
    /* renamed from: com.appnext.banners.g$a */
    public class C1215a {
        @JavascriptInterface
        ...
        public void openStore(String str) {
            C1205g.this.handler.removeCallbacksAndMessages(null);
            if (!C1205g.this.isDestroyed()) {
                C1205g.this.handler.post(new Runnable() {
                    /* JADX WARNING: Code restructure failed: missing block: B:24:0x00c5, code lost:
                        r6.f3841ga.f3840fW.click();
                     */
                    ...
                    public final void run() {
                        /*
                            r6 = this;
                            com.appnext.banners.g$a r0 = com.appnext.banners.C1205g.C1215a.this
                            com.appnext.banners.g r0 = com.appnext.banners.C1205g.this
                            com.appnext.banners.BannerAdData r0 = r0.getSelectedAd()
                            java.lang.String r0 = r0.getWebview()
                        ...
                        L_0x001c:
                            ...
                            com.appnext.banners.g r0 = com.appnext.banners.C1205g.this
                            com.appnext.banners.BannerAdData r0 = r0.getSelectedAd()
                            java.lang.String r0 = r0.getRevenueType()
                            ...
                            r4.<init>()
                            com.appnext.banners.g$a r5 = com.appnext.banners.C1205g.C1215a.this
                            com.appnext.banners.g r5 = com.appnext.banners.C1205g.this
                            com.appnext.banners.BannerSize r5 = r5.getBannerSize()
                            java.lang.String r5 = r5.toString()
                            r4.append(r5)
                            java.lang.String r5 = "_cpiActiveFlow"
                            r4.append(r5)
                            ...
                            int r4 = r0.hashCode()
                            switch(r4) {
                                case 97: goto L_0x009e;
                                case 98: goto L_0x0094;
                                case 99: goto L_0x008a;
                        ...
                        L_0x00cd:
                            ...
                            java.lang.String r5 = r5.toString()
                            r4.append(r5)
                            java.lang.String r5 = "_cpcActiveFlow"
                            r4.append(r5)
                            java.lang.String r4 = r4.toString()
                            java.lang.String r0 = r0.get(r4)
                            java.lang.String r0 = r0.toLowerCase()
                        ...
                        L_0x013e:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.appnext.banners.C1205g.C1215a.C12161.run():void");
                    }
                });
            }
        }
        ...
        public void openLink(String str) {
            if (!C1205g.this.isDestroyed()) {
                C1205g.this.openLink(str);
            }
        }

        @JavascriptInterface
        public void logSTP(String str, String str2) {
            C1326f.m5664a((C1286Ad) C1205g.this.getBannerAd(), (AppnextAd) C1205g.this.getSelectedAd(), str, str2, (C1345p) C1202d.m5145aI());
        }
    }

    /* renamed from: com.appnext.banners.g$b */
    public class C1217b extends WebViewClient {
        public C1217b() {
        }
        ...
        public final void onPageFinished(WebView webView, String str) {
            ...
            C1205g.this.pageFinished();
        }
    }

    /* access modifiers changed from: protected */
    public String getJSurl() {
        return "http://cdn.appnext.com/tools/sdk/banner/2.4.3/banner.min.js";
    }
    ...
    public void inflateView(int i, AppnextAd appnextAd) {
        ...
        AppnextWebView.m5797B(this.context).mo6321a(jSurl, (C1376c) new C1376c() {
            /* renamed from: b */
            public final void mo5656b(String str) {
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    public final void run() {
                        C1205g.this.loadWebview(jSurl, AppnextWebView.m5797B(C1205g.this.context).mo6324aV(jSurl));
                    }
                });
            }
            ...
            public final void error(String str) {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    public final void run() {
                        C1205g.this.loadWebview(jSurl, C1205g.this.getFallbackScript());
                    }
                });
            }
        });
        AppnextWebView.m5797B(this.context).mo6321a(getTargetJSurl(), (C1376c) null);
    ...
    public int getLayout() {
        if (getBannerSize().toString().equals(BannerSize.BANNER.toString())) {
            return C1166R.layout.apnxt_banner;
        }
        if (getBannerSize().toString().equals(BannerSize.LARGE_BANNER.toString())) {
            return C1166R.layout.apnxt_large_banner;
        }
        if (getBannerSize().toString().equals(BannerSize.MEDIUM_RECTANGLE.toString())) {
            return C1166R.layout.apnxt_medium_rectangle;
        }
        StringBuilder sb = new StringBuilder("Wrong banner size ");
        sb.append(getBannerSize().toString());
    ...
    public void destroy() {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public final void run() {
                try {
                    ((ViewGroup) C1205g.this.webView.getParent()).removeView(C1205g.this.webView);
                } catch (Throwable unused) {
                }
                if (C1205g.this.webView != null) {
                    C1205g.this.webView.destroyDrawingCache();
                    C1205g.this.webView.destroy();
                }
            }
        });
    ...
    public JSONObject getConfigParams() throws JSONException {
        ...
        jSONObject.put("pview", C1202d.m5145aI().get("pview"));
        ...
        jSONObject.put("remove_poster_on_auto_play", C1202d.m5145aI().get("remove_poster_on_auto_play"));
        ...
        jSONObject.put("gdpr", C1336k.m5716a((AppnextAd) getSelectedAd(), (C1345p) C1202d.m5145aI()));
    ...
    public BannerAdData getSelectedAd() {
        if (this.selectedAd == null || !super.getSelectedAd().getBannerID().equals(this.selectedAd.getBannerID())) {
            this.selectedAd = new BannerAdData(super.getSelectedAd());
            BannerAdData bannerAdData = this.selectedAd;
            StringBuilder sb = new StringBuilder();
            sb.append(this.selectedAd.getImpressionURL());
            sb.append("&tem_id=");
            sb.append(getBannerAd().getTemId(this.selectedAd));
            bannerAdData.setImpressionURL(sb.toString());
            BannerAdData bannerAdData2 = this.selectedAd;
            StringBuilder sb2 = new StringBuilder();
            sb2.append(this.selectedAd.getAppURL());
            sb2.append("&tem_id=");
            sb2.append(getBannerAd().getTemId(this.selectedAd));
            bannerAdData2.setAppURL(sb2.toString());
        }
    ...
    public void pageFinished() {
        if (!isDestroyed()) {
            new Thread(new Runnable() {
                public final void run() {
                    C1205g.this.adsid = C1326f.m5675b(C1205g.this.context, false);
                    C1205g.this.handler.removeCallbacksAndMessages(null);
                    C1205g.this.handler.post(new Runnable() {
                        public final void run() {
                            try {
                                C1205g.this.loadJS("javascript:(function() { try { Appnext.Layout.destroy('internal'); } catch(err){ Appnext.jsError(err.message); }})()");
                                C1205g gVar = C1205g.this;
                                StringBuilder sb = new StringBuilder("javascript:(function() { try { Appnext.setParams(");
                                sb.append(C1205g.this.getConfigParams().toString());
                                sb.append("); } catch(err){ Appnext.jsError(err.message); }})()");
                                gVar.loadJS(sb.toString());
                                C1205g gVar2 = C1205g.this;
                                StringBuilder sb2 = new StringBuilder("javascript:(function() { try { Appnext.loadBanner(");
                                sb2.append(new JSONObject(C1205g.this.getSelectedAd().getAdJSON()).toString());
                                sb2.append(",'");
                                sb2.append(C1205g.this.getBannerSize().toString());
                                sb2.append("'); } catch(err){ Appnext.jsError(err.message); }})()");
                                gVar2.loadJS(sb2.toString());
                                C1205g.this.shown.add(C1205g.this.getSelectedAd().getBannerID());
                            } catch (Throwable unused) {
                            }
                        }
                    });
    ...
    private void activateAutoRefresh() {
        int i;
        C1202d aI = C1202d.m5145aI();
        try {
            StringBuilder sb = new StringBuilder();
            sb.append(getBannerSize().toString().toLowerCase());
            sb.append("_ar");
            i = Integer.parseInt(aI.get(sb.toString()));
        } catch (Throwable unused) {
            i = 10;
        }
        if (Boolean.parseBoolean(aI.get("_arFlag")) && i > 0) {
            this.refreshHandler.postDelayed(new Runnable() {
                public final void run() {
                    try {
                        AppnextAd a = C1200b.m5130aH().mo5850a(C1205g.this.context, (C1286Ad) C1205g.this.getBannerAd(), C1205g.this.getAds(), C1205g.this.getAdRequest().getCreativeType(), C1205g.this.shown);
                        if (a != null) {
                            C1205g.this.setSelectedAd(new BannerAdData(a));
                            if (Boolean.parseBoolean(C1202d.m5145aI().get("impOne"))) {
                                C1205g.this.setReportedImpression(false);
                                C1205g.this.impression();
                            } else if (Boolean.parseBoolean(C1202d.m5145aI().get("pview"))) {
                                C1205g.this.refreshHandler.postDelayed(new Runnable() {
                                    public final void run() {
                                        C1205g.this.getUserAction().mo6290a(C1205g.this.getSelectedAd(), C1205g.this.getSelectedAd().getAppURL(), null);
                                    }
                                }, (long) (Integer.parseInt(C1202d.m5145aI().get("postpone_vta_sec")) * AdError.NETWORK_ERROR_CODE));
                            }
                            C1205g.this.pageFinished();
                        }
                    } catch (Throwable unused) {
            ...
            }, (long) (i * AdError.NETWORK_ERROR_CODE));
        }
    }
