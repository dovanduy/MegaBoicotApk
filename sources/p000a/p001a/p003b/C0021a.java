...
public final class C0021a {
    @NotNull
    /* renamed from: a */
    public static final <T> Class<T> m24a(@NotNull C0048b<T> bVar) {
        C0032h.m45b(bVar, "receiver$0");
        ...
        if (a.isPrimitive()) {
            ...
            throw new C0073h("null cannot be cast to non-null type java.lang.Class<T>");
        } else if (a != null) {
            return a;
        } else {
            throw new C0073h("null cannot be cast to non-null type java.lang.Class<T>");
