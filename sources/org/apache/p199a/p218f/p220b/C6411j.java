...
/* renamed from: org.apache.a.f.b.j */
/* compiled from: DefaultProxyAuthenticationHandler */
public class C6411j extends C6402a {
    /* renamed from: a */
    public boolean mo22440a(C6560q qVar, C6539e eVar) {
        if (qVar != null) {
            return qVar.mo22937a().mo22430b() == 407;
        }
    ...
    public Map<String, C6301c> mo22441b(C6560q qVar, C6539e eVar) throws C6258j {
        if (qVar != null) {
            return mo22711a(qVar.mo22910b("Proxy-Authenticate"));
        }
        throw new IllegalArgumentException("HTTP response may not be null");
    }
    ...
    public List<String> mo22712c(C6560q qVar, C6539e eVar) {
        List<String> list = (List) qVar.mo22915f().mo22751a("http.auth.proxy-scheme-pref");
        if (list != null) {
            return list;
        }
