...
public class C0402b {
    ...
    public static class C0404b {
        ...
        C0404b(char c, float[] fArr) {
            this.f1015a = c;
            this.f1016b = fArr;
        }

        C0404b(C0404b bVar) {
            this.f1015a = bVar.f1015a;
            this.f1016b = C0402b.m1512a(bVar.f1016b, 0, bVar.f1016b.length);
        }

        /* renamed from: a */
        public static void m1520a(C0404b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                m1519a(path, fArr, c, bVarArr[i].f1015a, bVarArr[i].f1016b);
                c = bVarArr[i].f1015a;
            }
        }

        /* renamed from: a */
        public void mo1427a(C0404b bVar, C0404b bVar2, float f) {
            for (int i = 0; i < bVar.f1016b.length; i++) {
                this.f1016b[i] = (bVar.f1016b[i] * (1.0f - f)) + (bVar2.f1016b[i] * f);
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:51:0x0180, code lost:
            ...
            r11 = r8;
            r26 = r9;
            m1518a(r10, r8, r7, r3, r4, r5, r6, r23, r24, r25);
            r8 = r11 + r13[r14];
            r7 = r12 + r13[r15];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:88:0x02c9, code lost:
            m1518a(r10, r11, r12, r3, r4, r5, r6, r7, r8, r9);
            r8 = r13[r14];
            r7 = r13[r15];
         */
        ...
        private static void m1519a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            /*
                r10 = r27
                r13 = r31
                r14 = 0
            ...
            L_0x0180:
                ...
                r26 = r9
                r9 = r25
                m1518a(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9)
                r0 = r13[r14]
                float r8 = r11 + r0
                r0 = r13[r15]
                float r7 = r12 + r0
            ...
            L_0x02dd:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p017v4.graphics.C0402b.C0404b.m1519a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: a */
        private static void m1518a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            float f8 = f;
            float f9 = f3;
            ...
            if (d23 < 0.0d) {
                ...
                m1518a(path, f, f2, f9, f4, f10 * sqrt, f11 * sqrt, f7, z, z2);
                return;
            }
            boolean z4 = z2;
            ...
            double d26 = d2 * d14;
            double d27 = d * d10;
            m1517a(path, (d26 * d22) - (d27 * d20), (d26 * d20) + (d27 * d22), d14, d10, d6, d9, d4, atan2, atan22);
        }

        /* renamed from: a */
        private static void m1517a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
    ...
    /* renamed from: a */
    static float[] m1512a(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    /* renamed from: a */
    public static Path m1508a(String str) {
        Path path = new Path();
        C0404b[] b = m1515b(str);
        if (b == null) {
            return null;
    ...
    /* renamed from: b */
    public static C0404b[] m1515b(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m1510a(arrayList, trim.charAt(0), m1516c(trim));
            }
            i2 = a;
            i = a + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m1510a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0404b[]) arrayList.toArray(new C0404b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0404b[] m1513a(C0404b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C0404b[] bVarArr2 = new C0404b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C0404b(bVarArr[i]);
        }
        return bVarArr2;
    }

    /* renamed from: a */
    public static boolean m1511a(C0404b[] bVarArr, C0404b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f1015a != bVarArr2[i].f1015a || bVarArr[i].f1016b.length != bVarArr2[i].f1016b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: b */
    public static void m1514b(C0404b[] bVarArr, C0404b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f1015a = bVarArr2[i].f1015a;
            for (int i2 = 0; i2 < bVarArr2[i].f1016b.length; i2++) {
                bVarArr[i].f1016b[i2] = bVarArr2[i].f1016b[i2];
            }
        }
    }

    /* renamed from: a */
    private static int m1507a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m1510a(ArrayList<C0404b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0404b(c, fArr));
    }

    /* renamed from: c */
    private static float[] m1516c(String str) {
        ...
        try {
            ...
            while (i < length) {
                ...
                i = aVar.f1014b ? i3 : i3 + 1;
            }
            return m1512a(fArr, 0, i2);
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void m1509a(java.lang.String r8, int r9, android.support.p017v4.graphics.C0402b.C0403a r10) {
        /*
            r0 = 0
            r10.f1014b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p017v4.graphics.C0402b.m1509a(java.lang.String, int, android.support.v4.graphics.b$a):void");
    }
}
