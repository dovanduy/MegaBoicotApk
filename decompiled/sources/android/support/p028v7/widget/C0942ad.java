...
public class C0942ad extends C0895r {
    ...
    public C0942ad(Context context) {
    ...
    public void onTargetFound(View view, C0898s sVar, C0896a aVar) {
        ...
        if (calculateTimeForDeceleration > 0) {
            aVar.mo4475a(-calculateDxToMakeVisible, -calculateDyToMakeVisible, calculateTimeForDeceleration, this.mDecelerateInterpolator);
        }
    }

    /* access modifiers changed from: protected */
    public void onSeekTargetStep(int i, int i2, C0898s sVar, C0896a aVar) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    /* access modifiers changed from: protected */
    public void updateActionForInterimTarget(C0896a aVar) {
        PointF computeScrollVectorForPosition = computeScrollVectorForPosition(getTargetPosition());
        if (computeScrollVectorForPosition == null || (computeScrollVectorForPosition.x == 0.0f && computeScrollVectorForPosition.y == 0.0f)) {
            aVar.mo4474a(getTargetPosition());
            stop();
            return;
        }
        ...
        aVar.mo4475a((int) (((float) this.mInterimTargetDx) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) this.mInterimTargetDy) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) calculateTimeForScrolling(10000)) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
    }
