...
public class C0040o {
    ...
    /* renamed from: a */
    public String mo69a(C0033i iVar) {
        return mo68a((C0030f) iVar);
    }

    /* renamed from: a */
    public String mo68a(C0030f fVar) {
        String obj = fVar.getClass().getGenericInterfaces()[0].toString();
        return obj.startsWith("truenet.kotlin.jvm.functions.") ? obj.substring("truenet.kotlin.jvm.functions.".length()) : obj;
    }
}
