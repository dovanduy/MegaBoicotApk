...
public class AdError {
    ...
    public static AdError getAdErrorFromWrapper(C1782a aVar) {
        return aVar.mo7635a().isPublicError() ? new AdError(aVar.mo7635a().getErrorCode(), aVar.mo7636b()) : new AdError(AdErrorType.UNKNOWN_ERROR.getErrorCode(), AdErrorType.UNKNOWN_ERROR.getDefaultErrorMessage());
    }
