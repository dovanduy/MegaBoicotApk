...
public class C5079b extends LinearLayout {

    /* renamed from: a */
    private static Map<String, String> f16424a = new HashMap<String, String>() {
        {
    ...
    public void setRating(float f) {
        ...
        for (int i3 = 0; i3 < floor; i3++) {
            m21896a("filled_star.png");
        }
        if (i != 0) {
            m21896a("half_star.png");
        }
        for (int i4 = 0; i4 < i2; i4++) {
            m21896a("empty_star.png");
        }
    }

    /* renamed from: a */
    private void m21896a(String str) {
        try {
            int a = C5306h.m22641a(getContext(), 2);
            int a2 = C5306h.m22641a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a3 = C5295a.m22608a(getContext(), str);
            if (a3 == null) {
                a3 = C5513d.m23539a((String) f16424a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a3, C5306h.m22641a(getContext(), 15), C5306h.m22641a(getContext(), 15), true));
