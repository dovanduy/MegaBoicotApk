...
public class C5303f {
    ...
    /* renamed from: a */
    private static boolean f17035a = true;

    /* renamed from: a */
    public static void m22633a(Context context, boolean z) {
        boolean z2 = true;
        if (z) {
            f17035a = true;
            C5414k.m23099b(context, "copyDrawables", Boolean.valueOf(true));
        }
        if (f17035a) {
            f17035a = C5414k.m23092a(context, "copyDrawables", Boolean.valueOf(true)).booleanValue();
            if (f17035a) {
                String str = "drawable-hdpi.zip";
                try {
                    String str2 = context.getPackageManager().getApplicationInfo(context.getPackageName(), 0).sourceDir;
                    String a = m22631a(context);
                    if (!m22634a(context, str2, "", str) && !m22634a(context, str2, "assets/", str) && !m22634a(context, a, "", str)) {
                        if (!m22634a(context, a, "assets/", str)) {
                            z2 = false;
                        }
                    }
                    if (!z2) {
                        C5518g.m23563a("ResourceHandler", 5, "Error initializing resources");
                    }
                } catch (Exception e) {
                    C5518g.m23564a("ResourceHandler", 6, "Error initializing resources", e);
                }
            }
        }
    }
    ...
    /* renamed from: a */
    private static String m22631a(Context context) {
    ...
    /* renamed from: a */
    private static boolean m22634a(Context context, String str, String str2, String str3) {
        StringBuilder sb = new StringBuilder();
        sb.append("Trying to copy resources from ");
        sb.append(str);
        sb.append(" in /");
        sb.append(str2);
        C5518g.m23563a("ResourceHandler", 3, sb.toString());
        ...
        sb4.append("/");
        sb4.append(str3);
        if (!m22635a(str, sb3, sb4.toString())) {
            StringBuilder sb5 = new StringBuilder();
            sb5.append("Failed copying resources from ");
            sb5.append(str);
            sb5.append(" in /");
            sb5.append(str2);
            C5518g.m23563a("ResourceHandler", 3, sb5.toString());
            return false;
        }
        StringBuilder sb6 = new StringBuilder();
        ...
        m22635a(str, sb8, sb9.toString());
        StringBuilder sb10 = new StringBuilder();
        sb10.append(context.getFilesDir().getPath());
        sb10.append("/");
        sb10.append("drawable.zip");
        m22632a(context, sb10.toString());
        C5414k.m23099b(context, "copyDrawables", Boolean.valueOf(false));
        ...
        C5518g.m23563a("ResourceHandler", 3, sb11.toString());
        return true;
    }
    ...
    protected static boolean m22635a(java.lang.String r5, java.lang.String r6, java.lang.String r7) {
        /*
            r0 = 0
            r1 = 0
        ...
        L_0x006f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.android.publish.adsCommon.Utils.C5303f.m22635a(java.lang.String, java.lang.String, java.lang.String):boolean");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected static void m22632a(android.content.Context r7, java.lang.String r8) {
        /*
        ...
        L_0x006e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.android.publish.adsCommon.Utils.C5303f.m22632a(android.content.Context, java.lang.String):void");
    }
}
