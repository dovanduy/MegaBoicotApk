...
public final class C4339yd {

    /* renamed from: a */
    private ECPublicKey f14235a;

    public C4339yd(ECPublicKey eCPublicKey) {
        this.f14235a = eCPublicKey;
    }

    /* renamed from: a */
    public final C4340ye mo16215a(String str, byte[] bArr, byte[] bArr2, int i, C4344yi yiVar) throws GeneralSecurityException {
        byte[] bArr3;
        KeyPair a = C4341yf.m18669a(this.f14235a.getParams());
        ECPublicKey eCPublicKey = (ECPublicKey) a.getPublic();
        ECPrivateKey eCPrivateKey = (ECPrivateKey) a.getPrivate();
        ECPublicKey eCPublicKey2 = this.f14235a;
        ECParameterSpec params = eCPublicKey2.getParams();
        ECParameterSpec params2 = eCPrivateKey.getParams();
        if (!params.getCurve().equals(params2.getCurve()) || !params.getGenerator().equals(params2.getGenerator()) || !params.getOrder().equals(params2.getOrder()) || params.getCofactor() != params2.getCofactor()) {
            throw new GeneralSecurityException("invalid public key spec");
        }
        byte[] a2 = C4341yf.m18674a(eCPrivateKey, eCPublicKey2.getW());
        EllipticCurve curve = eCPublicKey.getParams().getCurve();
        ECPoint w = eCPublicKey.getW();
        C4341yf.m18673a(w, curve);
        int a3 = C4341yf.m18668a(curve);
        int i2 = 1;
        switch (C4342yg.f14238a[yiVar.ordinal()]) {
            case 1:
                int i3 = (2 * a3) + 1;
        ...
        byte[] a4 = C4331xw.m18656a(bArr3, a2);
        Mac mac = (Mac) C4346yk.f14251b.mo16218a(str);
        ...
        while (true) {
            ...
            if (bArr6.length + i5 < i) {
                ...
                return new C4340ye(bArr3, bArr5);
            }
        }
    }
}
