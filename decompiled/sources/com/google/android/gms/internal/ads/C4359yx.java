...
final class C4359yx {
    /* renamed from: a */
    private static long m18694a(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16))) & 4294967295L;
    }

    /* renamed from: a */
    private static long m18695a(byte[] bArr, int i, int i2) {
        return (m18694a(bArr, i) >> i2) & 67108863;
    }

    /* renamed from: a */
    private static void m18696a(byte[] bArr, long j, int i) {
        int i2 = 0;
        while (i2 < 4) {
    ...
    /* renamed from: a */
    static byte[] m18697a(byte[] bArr, byte[] bArr2) {
        byte[] bArr3 = bArr;
        byte[] bArr4 = bArr2;
        if (bArr3.length != 32) {
            throw new IllegalArgumentException("The key length in bytes must be 32.");
        }
        long a = m18695a(bArr3, 0, 0) & 67108863;
        int i = 2;
        int i2 = 3;
        long a2 = m18695a(bArr3, 3, 2) & 67108611;
        long a3 = m18695a(bArr3, 6, 4) & 67092735;
        long a4 = m18695a(bArr3, 9, 6) & 66076671;
        long a5 = m18695a(bArr3, 12, 8) & 1048575;
        long j = a2 * 5;
        long j2 = a3 * 5;
        long j3 = a4 * 5;
        long j4 = a5 * 5;
        ...
        while (i3 < bArr4.length) {
            ...
            long a6 = j9 + m18695a(bArr5, 0, 0);
            long a7 = j5 + m18695a(bArr5, i2, i);
            long a8 = j6 + m18695a(bArr5, 6, 4);
            long a9 = j7 + m18695a(bArr5, 9, 6);
            long a10 = j8 + (m18695a(bArr5, 12, 8) | ((long) (bArr5[16] << 24)));
        ...
        long a11 = j56 + m18694a(bArr3, 16);
        long j59 = a11 & 4294967295L;
        long a12 = (((j53 >> 6) | (j54 << 20)) & 4294967295L) + m18694a(bArr3, 20) + (a11 >> 32);
        long j60 = a12 & 4294967295L;
        long a13 = j57 + m18694a(bArr3, 24) + (a12 >> 32);
        long j61 = a13 & 4294967295L;
        long a14 = (j58 + m18694a(bArr3, 28) + (a13 >> 32)) & 4294967295L;
        byte[] bArr6 = new byte[16];
        m18696a(bArr6, j59, 0);
        m18696a(bArr6, j60, 4);
        m18696a(bArr6, j61, 8);
        m18696a(bArr6, a14, 12);
        return bArr6;
    }
}
