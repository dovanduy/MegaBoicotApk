...
/* renamed from: com.google.android.gms.internal.e.fv */
abstract class C4609fv {
    C4609fv() {
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract int mo16804a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract int mo16805a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract void mo16806a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: 0000 */
    /* renamed from: b */
    public abstract String mo16808b(byte[] bArr, int i, int i2) throws C4526db;

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final boolean mo16807a(byte[] bArr, int i, int i2) {
        return mo16804a(0, bArr, i, i2) == 0;
    }

    /* renamed from: b */
    static void m19959b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
        ...
        while (i2 < length) {
            ...
            if (charAt3 < 128) {
                ...
                i = position + 1;
                try {
                    byteBuffer.put(position, (byte) (192 | (charAt3 >>> 6)));
                ...
                i = position + 1;
                byteBuffer.put(position, (byte) (224 | (charAt3 >>> 12)));
                position = i + 1;
                ...
                if (i3 != length) {
                    try {
                        ...
                        if (!Character.isSurrogatePair(charAt3, charAt4)) {
                            ...
                            int i4 = position + 1;
                            try {
                                byteBuffer.put(position, (byte) (240 | (codePoint >>> 18)));
                                position = i4 + 1;
                                byteBuffer.put(i4, (byte) (((codePoint >>> 12) & 63) | 128));
                                i4 = position + 1;
                                byteBuffer.put(position, (byte) (((codePoint >>> 6) & 63) | 128));
                                byteBuffer.put(i4, (byte) ((63 & codePoint) | 128));
                                position = i4;
                                i2 = i3;
