...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static final class VSyncSampler implements Callback, FrameCallback {
        ...
        public volatile long sampledVsyncTimeNs = C2793C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (this.observerCount == 0) {
                ...
                this.sampledVsyncTimeNs = C2793C.TIME_UNSET;
            }
        }
    }
    ...
    public VideoFrameReleaseTimeHelper(Context context) {
        ...
        this.vsyncDurationNs = C2793C.TIME_UNSET;
        this.vsyncOffsetNs = C2793C.TIME_UNSET;
    }
