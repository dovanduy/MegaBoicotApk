...
class CachedContentIndex {
    ...
    public void maybeRemove(String str) {
        ...
        if (cachedContent != null && cachedContent.isEmpty() && !cachedContent.isLocked()) {
            ...
            this.idToKey.remove(cachedContent.f8658id);
            this.changed = true;
        }
    }
    ...
    private boolean readFile() {
        /*
            ...
            r0 = 0
            r1 = 0
            java.io.BufferedInputStream r2 = new java.io.BufferedInputStream     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            com.google.android.exoplayer2.util.AtomicFile r3 = r9.atomicFile     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            java.io.InputStream r3 = r3.openRead()     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            r2.<init>(r3)     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            java.io.DataInputStream r3 = new java.io.DataInputStream     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            r3.<init>(r2)     // Catch:{ IOException -> 0x00a3, all -> 0x009b }
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            if (r1 < 0) goto L_0x0093
            r4 = 2
            if (r1 <= r4) goto L_0x001d
            goto L_0x0093
        L_0x001d:
            int r5 = r3.readInt()     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0057
            javax.crypto.Cipher r5 = r9.cipher     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
        ...
        L_0x002f:
            r5 = 16
            byte[] r5 = new byte[r5]     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r3.readFully(r5)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            javax.crypto.spec.IvParameterSpec r7 = new javax.crypto.spec.IvParameterSpec     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r7.<init>(r5)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            javax.crypto.Cipher r5 = r9.cipher     // Catch:{ InvalidAlgorithmParameterException | InvalidKeyException -> 0x0050 }
            javax.crypto.spec.SecretKeySpec r8 = r9.secretKeySpec     // Catch:{ InvalidAlgorithmParameterException | InvalidKeyException -> 0x0050 }
            r5.init(r4, r8, r7)     // Catch:{ InvalidAlgorithmParameterException | InvalidKeyException -> 0x0050 }
            java.io.DataInputStream r4 = new java.io.DataInputStream     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            javax.crypto.CipherInputStream r5 = new javax.crypto.CipherInputStream     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            javax.crypto.Cipher r7 = r9.cipher     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
        ...
        L_0x0050:
            r1 = move-exception
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r2.<init>(r1)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            throw r2     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
        L_0x0057:
            boolean r2 = r9.encrypt     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            if (r2 == 0) goto L_0x005d
            r9.changed = r6     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
        L_0x005d:
            int r2 = r3.readInt()     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r4 = r0
            r5 = r4
        L_0x0063:
            if (r4 >= r2) goto L_0x0074
            com.google.android.exoplayer2.upstream.cache.CachedContent r7 = com.google.android.exoplayer2.upstream.cache.CachedContent.readFromStream(r1, r3)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r9.add(r7)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            int r7 = r7.headerHashCode(r1)     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            int r5 = r5 + r7
            int r4 = r4 + 1
            goto L_0x0063
        L_0x0074:
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            int r2 = r3.read()     // Catch:{ IOException -> 0x00a4, all -> 0x0099 }
            r4 = -1
    ...
    private void add(CachedContent cachedContent) {
        ...
        this.idToKey.put(cachedContent.f8658id, cachedContent.key);
    }
