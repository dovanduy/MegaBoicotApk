...
public class SsManifest implements FilterableManifest<SsManifest, StreamKey> {
    ...
    public static class StreamElement {
        ...
        public StreamElement copy(Format[] formatArr) {
            ...
            List<Long> list = this.chunkStartTimes;
            List<Long> list2 = list;
            Format[] formatArr2 = formatArr;
            List<Long> list3 = list2;
            StreamElement streamElement = new StreamElement(str, str2, i, str3, j, str4, i2, i3, i4, i5, str5, formatArr2, list3, this.chunkStartTimesUs, this.lastChunkDurationUs);
    ...
    public SsManifest(int i, int i2, long j, long j2, long j3, int i3, boolean z, ProtectionElement protectionElement2, StreamElement[] streamElementArr) {
        ...
        long j4 = C2793C.TIME_UNSET;
        long scaleLargeTimestamp = i4 == 0 ? -9223372036854775807L : Util.scaleLargeTimestamp(j2, 1000000, j);
        if (j3 != 0) {
