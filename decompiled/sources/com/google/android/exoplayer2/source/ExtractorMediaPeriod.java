...
final class ExtractorMediaPeriod implements ExtractorOutput, MediaPeriod, UpstreamFormatChangedListener, Callback<ExtractingLoadable>, ReleaseCallback {
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        if (this.durationUs == C2793C.TIME_UNSET) {
    ...
    public void maybeFinishPrepare() {
        if (!this.released && !this.prepared && this.seekMap != null && this.sampleQueuesBuilt) {
            ...
            if (this.minLoadableRetryCount == -1 && this.length == -1 && this.seekMap.getDurationUs() == C2793C.TIME_UNSET) {
    ...
    private void startLoading() {
        ...
        if (this.prepared) {
            ...
            if (this.durationUs == C2793C.TIME_UNSET || this.pendingResetPositionUs < this.durationUs) {
    ...
    private boolean configureRetry(ExtractingLoadable extractingLoadable, int i) {
        if (this.length == -1 && (this.seekMap == null || this.seekMap.getDurationUs() == C2793C.TIME_UNSET)) {
