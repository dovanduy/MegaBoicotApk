...
public final class SampleQueue implements TrackOutput {
    ...
    public int read(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z, boolean z2, long j) {
        switch (this.metadataQueue.read(formatHolder, decoderInputBuffer, z, z2, this.downstreamFormat, this.extrasHolder)) {
            case C2793C.RESULT_FORMAT_READ /*-5*/:
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (decoderInputBuffer2.cryptoInfo.f8629iv == null) {
            decoderInputBuffer2.cryptoInfo.f8629iv = new byte[16];
        }
        readData(j3, decoderInputBuffer2.cryptoInfo.f8629iv, (int) b2);
        long j4 = j3 + ((long) b2);
        if (z) {
        ...
        decoderInputBuffer2.cryptoInfo.set(i2, iArr2, iArr4, cryptoData.encryptionKey, decoderInputBuffer2.cryptoInfo.f8629iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
        int i5 = (int) (j - sampleExtrasHolder2.offset);
