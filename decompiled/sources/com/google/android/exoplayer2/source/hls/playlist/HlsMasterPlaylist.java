...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public HlsMasterPlaylist copy(List<RenditionKey> list) {
        HlsMasterPlaylist hlsMasterPlaylist = new HlsMasterPlaylist(this.baseUri, this.tags, copyRenditionsList(this.variants, 0, list), copyRenditionsList(this.audios, 1, list), copyRenditionsList(this.subtitles, 2, list), this.muxedAudioFormat, this.muxedCaptionFormats);
