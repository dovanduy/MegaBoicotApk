...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static String getCharsetName(int i) {
        switch (i) {
            case 0:
                return "ISO-8859-1";
            case 1:
                return C2793C.UTF16_NAME;
            case 2:
                return "UTF-16BE";
            case 3:
                return C2793C.UTF8_NAME;
            default:
                return "ISO-8859-1";
        }
    }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (readUnsignedByte >= 4 || (readUnsignedByte2 & FRAME_FLAG_V3_IS_COMPRESSED) == 0) {
            z = false;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0091, code lost:
        if ((r11 & FRAME_FLAG_V3_IS_COMPRESSED) != 0) goto L_0x0082;
     */
