...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(String str) {
        ...
        if (hashCode != 3046605) {
            if (hashCode != 3046671) {
                if (hashCode != 3049879) {
                    if (hashCode == 3049895 && str.equals(C2793C.CENC_TYPE_cens)) {
                        c = 1;
                    }
                } else if (str.equals(C2793C.CENC_TYPE_cenc)) {
                    c = 0;
                }
            } else if (str.equals(C2793C.CENC_TYPE_cbcs)) {
                c = 3;
            }
        } else if (str.equals(C2793C.CENC_TYPE_cbc1)) {
            c = 2;
        }
        switch (c) {
            case 0:
