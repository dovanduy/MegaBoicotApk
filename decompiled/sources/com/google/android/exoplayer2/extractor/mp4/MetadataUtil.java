...
final class MetadataUtil {
    ...
    private static final int SHORT_TYPE_YEAR = Util.getIntegerCodeForString(C1245d.f3954iW);
    ...
    private static final int TYPE_INTERNAL = Util.getIntegerCodeForString(InternalFrame.f8640ID);
