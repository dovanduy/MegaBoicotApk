    ...
    private void readHeaderRemainder(ParsableByteArray parsableByteArray) {
        ...
        if (this.frameBytesRead >= 4) {
            ...
            if (!this.hasOutputFormat) {
                ...
                this.output.format(Format.createAudioSampleFormat(this.formatId, this.header.mimeType, null, -1, MpegAudioHeader.MAX_FRAME_SIZE_BYTES, this.header.channels, this.header.sampleRate, null, null, 0, this.language));
