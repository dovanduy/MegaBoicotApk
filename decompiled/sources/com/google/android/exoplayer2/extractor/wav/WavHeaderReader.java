...
final class WavHeaderReader {
    ...
    public static void skipToData(ExtractorInput extractorInput, WavHeader wavHeader) throws IOException, InterruptedException {
        ...
        while (peek.f8632id != Util.getIntegerCodeForString("data")) {
            String str = TAG;
            StringBuilder sb = new StringBuilder();
            sb.append("Ignoring unknown WAV chunk: ");
            sb.append(peek.f8632id);
            Log.w(str, sb.toString());
            long j = 8 + peek.size;
            if (peek.f8632id == Util.getIntegerCodeForString("RIFF")) {
                j = 12;
            }
            if (j > 2147483647L) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Chunk is too large (~2GB+) to skip; id: ");
                sb2.append(peek.f8632id);
