...
final class ExoPlayerImplInternal implements Callback, PlaybackParameterListener, Sender, MediaPeriod.Callback, SourceInfoRefreshListener, InvalidationListener {
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector2, TrackSelectorResult trackSelectorResult, LoadControl loadControl2, boolean z, int i, boolean z2, Handler handler2, ExoPlayer exoPlayer, Clock clock2) {
        ...
        this.clock = clock3;
        this.backBufferDurationUs = loadControl3.getBackBufferDurationUs();
        this.retainBackBufferFromKeyframe = loadControl3.retainBackBufferFromKeyframe();
        this.seekParameters = SeekParameters.DEFAULT;
        PlaybackInfo playbackInfo2 = new PlaybackInfo(Timeline.EMPTY, C2793C.TIME_UNSET, TrackGroupArray.EMPTY, trackSelectorResult2);
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f8627id;
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        if (z && ((j == C2793C.TIME_UNSET || j <= this.playbackInfo.positionUs) && playingPeriod.info.isFinal)) {
            setState(4);
            stopRenderers();
    ...
    private void seekToInternal(com.google.android.exoplayer2.ExoPlayerImplInternal.SeekPosition r24) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x0092:
            r8 = r13
        L_0x0093:
            long r11 = com.google.android.exoplayer2.C2793C.usToMs(r8)     // Catch:{ all -> 0x00e7 }
            com.google.android.exoplayer2.PlaybackInfo r2 = r1.playbackInfo     // Catch:{ all -> 0x00e7 }
            r21 = r8
            long r7 = r2.positionUs     // Catch:{ all -> 0x00e7 }
            long r6 = com.google.android.exoplayer2.C2793C.usToMs(r7)     // Catch:{ all -> 0x00e7 }
    ...
    private boolean shouldKeepPeriodHolder(MediaPeriodId mediaPeriodId, long j, MediaPeriodHolder mediaPeriodHolder) {
        if (mediaPeriodId.equals(mediaPeriodHolder.info.f8627id) && mediaPeriodHolder.prepared) {
            this.playbackInfo.timeline.getPeriod(mediaPeriodHolder.info.f8627id.periodIndex, this.period);
    ...
    private void resetInternal(boolean z, boolean z2, boolean z3) {
        ...
        PlaybackInfo playbackInfo2 = new PlaybackInfo(timeline, obj, mediaPeriodId, j2, j, this.playbackInfo.playbackState, false, z3 ? TrackGroupArray.EMPTY : this.playbackInfo.trackGroups, z3 ? this.emptyTrackSelectorResult : this.playbackInfo.trackSelectorResult);
        this.playbackInfo = playbackInfo2;
    ...
    private void sendMessageInternal(PlayerMessage playerMessage) throws ExoPlaybackException {
        if (playerMessage.getPositionMs() == C2793C.TIME_UNSET) {
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        if (pendingMessageInfo.resolvedPeriodUid == null) {
            Pair resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C2793C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:64:0x00a6 A[ADDED_TO_REGION, EDGE_INSN: B:64:0x00a6->B:77:0x00a6 ?: BREAK  
    EDGE_INSN: B:64:0x00a6->B:77:0x00a6 ?: BREAK  
    EDGE_INSN: B:64:0x00a6->B:77:0x00a6 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.info.durationUs;
        return j == C2793C.TIME_UNSET || this.playbackInfo.positionUs < j || (playingPeriod.next != null && (playingPeriod.next.prepared || playingPeriod.next.info.f8627id.isAd()));
    }
    ...
    private void handleSourceInfoRefreshed(MediaSourceRefreshInfo mediaSourceRefreshInfo) throws ExoPlaybackException {
        ...
        if (mediaSourceRefreshInfo2.source == this.mediaSource) {
            ...
            if (this.pendingPrepareCount > 0) {
                ...
                } else if (this.playbackInfo.startPositionUs == C2793C.TIME_UNSET) {
                    if (timeline2.isEmpty()) {
                        handleSourceInfoRefreshEndedPlayback();
                    } else {
                        Pair periodPosition = getPeriodPosition(timeline2, timeline2.getFirstWindowIndex(this.shuffleModeEnabled), C2793C.TIME_UNSET);
            ...
            if (indexOfPeriod == -1) {
                ...
                Pair periodPosition2 = getPeriodPosition(timeline2, timeline2.getPeriod(resolveSubsequentPeriod, this.period).windowIndex, C2793C.TIME_UNSET);
    ...
    private Pair<Integer, Long> resolveSeekPosition(SeekPosition seekPosition, boolean z) {
        ...
        try {
            ...
            if (z) {
                ...
                if (resolveSubsequentPeriod != -1) {
                    return getPeriodPosition(timeline, timeline.getPeriod(resolveSubsequentPeriod, this.period).windowIndex, C2793C.TIME_UNSET);
                }
            }
            return null;
        ...
        if (this.mediaSource != null) {
            ...
            if (this.queue.hasPlayingPeriod()) {
                ...
                while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.next.rendererPositionOffsetUs) {
                    ...
                    updatePlayingPeriodRenderers(playingPeriod);
                    this.playbackInfo = this.playbackInfo.fromNewPosition(advancePlayingPeriod.info.f8627id, advancePlayingPeriod.info.startPositionUs, advancePlayingPeriod.info.contentPositionUs);
                ...
                if (readingPeriod.info.isFinal) {
                    ...
                    boolean z2 = advanceReadingPeriod.mediaPeriod.readDiscontinuity() != C2793C.TIME_UNSET;
    ...
    private void maybeUpdateLoadingPeriod() throws IOException {
        ...
        if (this.queue.shouldLoadNextMediaPeriod()) {
            ...
            this.queue.enqueueNextMediaPeriod(this.rendererCapabilities, this.trackSelector, this.loadControl.getAllocator(), this.mediaSource, this.playbackInfo.timeline.getPeriod(nextMediaPeriodInfo.f8627id.periodIndex, this.period, true).uid, nextMediaPeriodInfo).prepare(this, nextMediaPeriodInfo.startPositionUs);
            setIsLoading(true);
        }
    }
