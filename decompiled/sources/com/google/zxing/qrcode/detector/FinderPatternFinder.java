...
public class FinderPatternFinder {
    ...
    private boolean crossCheckDiagonal(int i, int i2, int i3, int i4) {
        ...
        return crossCheckStateCount2[4] < i9 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) < 2 * i4 && foundPatternCross(crossCheckStateCount2);
    }
    ...
    private float crossCheckVertical(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount2[4] < i3 && 5 * Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) < 2 * i4 && foundPatternCross(crossCheckStateCount2)) {
    ...
    private float crossCheckHorizontal(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount2[4] < i3 && 5 * Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) < i4 && foundPatternCross(crossCheckStateCount2)) {
            return centerFromEnd(crossCheckStateCount2, i6);
        }
        return Float.NaN;
    }
