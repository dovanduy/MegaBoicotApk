...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        String generateErrorCorrection = PDF417ErrorCorrection.generateErrorCorrection(sb3, i);
        this.barcodeMatrix = new BarcodeMatrix(i3, i2);
        StringBuilder sb4 = new StringBuilder();
        sb4.append(sb3);
        sb4.append(generateErrorCorrection);
        encodeLowLevel(sb4.toString(), i2, i3, i, this.barcodeMatrix);
    }
